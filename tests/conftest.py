...
def mp3_files(temp_dir: Path) -> Dict[str, Path]:
    ...
    subprocess.run([
        ...
        '-c:a', 'mp3', '-b:a', '128k', '-y', str(short_mp3)
    ...
    subprocess.run([
        ...
        '-c:a', 'mp3', '-b:a', '128k', '-y', str(long_mp3)
    ], capture_output=True, check=True)
    files['long'] = long_mp3
    ...
    subprocess.run([
        ...
        '-c:a', 'mp3', '-b:a', '128k', '-y', str(very_short_mp3)
    ], capture_output=True, check=True)
    ...
    subprocess.run([
        ...
        '-ar', '48000', '-c:a', 'mp3', '-b:a', '128k', '-y', str(high_samplerate_mp3)
    ], capture_output=True, check=True)
    ...
    metadata_configs = {
        'short': {'title': 'Test Short Track', 'artist': 'Test Artist', 'album': 'Test Album'},
        'long': {'title': 'Test Long Track', 'artist': 'Test Artist', 'album': 'Test Album'},
        'very_short': {'title': 'Very Short Track', 'artist': 'Test Artist', 'album': 'Test Album'},
        'high_samplerate': {'title': 'High Sample Rate Track', 'artist': 'Test Artist', 'album': 'Test Album'},
    }
